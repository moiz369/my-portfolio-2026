...
function getBotReply(rawMsg) {
  ...
  if (m.match(/^(hi|hey|hello|sup|yo|howdy)[\s!?]*$/))
    return "Hey! ≡ƒæï I'm Moiz-Bot, trained on Moiz's full resume. Ask me anything ΓÇö skills, projects, GPA, availability, or how to hire him. Or just say 'tell me everything'!"

  if (m.match(/who are you|what are you|introduce yourself|what is this bot/))
    return "I'm Moiz-Bot ≡ƒñû ΓÇö an AI assistant built into this portfolio, trained on Moiz Khan's resume. I can answer anything about his skills, projects, education, experience, and how to get in touch!"

  if (m.match(/tell me everything|full overview|full summary|complete profile|everything about/))
    return "Here's the full picture ≡ƒùé∩╕Å\n\nMoiz Khan is a Full Stack Web Developer & Software Engineer from Islamabad, Pakistan. BSc Software Engineering at NUML with a 3.9/4.0 GPA. He's built 4 real projects: AI Dermatology App (FYP), MERN Jewellery Store, Arts & Crafts eCommerce, and a Java/C++ Parking System. Stack: Python, Django, React, Node.js, MERN, SQL, AI Integration. Open to full-time & freelance work.\n\n≡ƒô⌐ moizkh369@gmail.com"

  if (m.match(/summar|about|who is|overview|professional|background|descri|what does moiz do|what do/))
    return "Moiz is a passionate Full Stack Web Developer & Software Engineer dedicated to building robust, end-to-end web applications. He's a natural leader, highly detail-oriented, and committed to delivering flawless solutions from conception to deployment. His vision: leverage advanced technologies to build scalable, revolutionary products with a positive global impact. ≡ƒîì"

  if (m.match(/skill|tech|language|framework|stack|know|use|work with|tool|capabilit|expertise|proficien|what can/))
    return "From his resume ≡ƒôï\n\n≡ƒÆ╗ Languages: Python, Java, C++, JavaScript, HTML, CSS, SQL\nΓÜÖ∩╕Å Frameworks: React, Node.js, Django, Express.js, AJAX, WordPress\n≡ƒùä∩╕Å Databases: SQL, MongoDB\n≡ƒ¢á∩╕Å Tools: GitHub, Visual Studio, Android Studio\n≡ƒºá Soft Skills: Leadership, Team Collaboration, Problem Solving, Project Management"

  if (m.match(/project|portfolio|what.*(built|made|creat|develop|work)/))
    return "Moiz has 4 projects on his resume ≡ƒÜÇ\n\n≡ƒ⌐║ AI Dermatology Assistant (FYP) ΓÇö Django, Python, AI\n≡ƒÆÄ Jewellery Store ΓÇö MERN Stack (500+ products)\n≡ƒÄ¿ Arts & Crafts eCommerce ΓÇö PHP/SQL (1000+ users)\n≡ƒÜù Car Parking System ΓÇö Java/C++ (5000+ vehicles)\n\nAsk about any one for full details!"

  if (m.match(/dermatol|skin|fyp|final year|healthcare|ai project|85|detection/))
    return "≡ƒ⌐║ Automated Dermatology Assistant (FYP) ΓÇö Mar 2025 to May 2026\n\nAI-integrated healthcare web app detecting 2 major skin conditions with 85%+ accuracy in under 2 seconds. Includes:\nΓÇó Patient dashboard for skin health tracking\nΓÇó Location-based dermatologist matching\nΓÇó Appointment booking system\n\nStack: Django, SQL, Python, AI Integration"

  if (m.match(/jewel|mern|ecommerce.*mern|mongodb|500.*product/))
    return "≡ƒÆÄ Jewellery Store Management System ΓÇö Nov to Dec 2025\n\nFull-stack e-commerce portal handling 500+ products. Features:\nΓÇó Responsive React frontend\nΓÇó RESTful API for catalog & pricing\nΓÇó Rapid database querying\n\nStack: MongoDB, Express.js, React, Node.js (MERN)"

  if (m.match(/art|craft|php|1000.*user|ecommerce.*php/))
    return "≡ƒÄ¿ Arts & Crafts eCommerce Platform ΓÇö Oct to Nov 2024\n\nNiche eCommerce platform supporting 1000+ concurrent users. Features:\nΓÇó Secure user authentication & input validation\nΓÇó Real-time database integrations\nΓÇó Full shopping & order management\n\nStack: HTML, CSS, JavaScript, PHP, SQL"

  if (m.match(/park|car|5000|java.*project|desktop|c\+\+.*project/))
    return "≡ƒÜù Car Parking Management System ΓÇö Oct to Nov 2022\n\nCentralized admin software tracking 5000+ vehicles with automated billing. Achievements:\nΓÇó 100% workflow efficiency improvement\nΓÇó Digitized entire manual entry system\nΓÇó Migrated C++ console to Java GUI\n\nStack: Java, C++, GUI Design, OOP"

  if (m.match(/edu|degree|university|numl|study|student|academ|school|college|qualif/))
    return "≡ƒÄô BSc Software Engineering\nNational University of Modern Languages (NUML), Islamabad\n≡ƒôà September 2022 ΓÇô Present\nΓ¡É GPA: 3.9 / 4.0 ΓÇö Distinction level"

  if (m.match(/gpa|grade|result|cgpa|mark|score|3\.9|distinction/))
    return "Moiz has a GPA of 3.9 out of 4.0 at NUML ≡ƒÅå ΓÇö distinction level. Impressive considering he simultaneously shipped 4 real-world projects during his studies!"

  if (m.match(/contact|email|phone|reach|number|call|message|get in touch|how to.*contact/))
    return "≡ƒô¼ Here's how to reach Moiz:\n\n≡ƒôº Email: moizkh369@gmail.com\n≡ƒô₧ Phone: 03335016753\n≡ƒôì Location: H9, Islamabad, Pakistan\n\nHe's responsive and happy to connect!"

  if (m.match(/hire|job|opportun|availab|freelance|intern|recruit|open to|looking for|employ|position|role/))
    return "Yes! Moiz is actively open to full-time roles, freelance projects, and internship opportunities ≡ƒÜÇ Remote and on-site both work. Best way: moizkh369@gmail.com or 03335016753."

  if (m.match(/hobb|interest|life|outside|personal|gym|music|vibe|free time|fun/))
    return "Outside of coding, Moiz is into ≡ƒÆ¬ Gym & Fitness, ≡ƒÄ╡ Music, ΓÜí Vibe Coding sessions, ≡ƒôê Self Improvement, and ≡ƒîì Exploring New Things. He believes a sharp developer needs a sharp life!"

  if (m.match(/english|urdu|speak|language.*speak|spoken/))
    return "Moiz speaks English at a professional proficiency level and Urdu natively. ≡ƒîÉ"

  if (m.match(/soft skill|leader|team|collaborat|manag|communicat|strength|best at/))
    return "His resume highlights: Leadership, Team Collaboration, Problem Solving, Project Management, and Detail-Oriented. He's led multiple technical teams to successful delivery. ≡ƒÆ╝"

  if (m.match(/python|django/))
    return "Python and Django are core to Moiz's backend stack. His FYP uses Django with AI integration. He builds Django REST APIs and is comfortable with SQL databases. ≡ƒÉì"

  if (m.match(/react|frontend|ui/))
    return "Moiz builds frontends with React.js ΓÇö demonstrated in his MERN Jewellery Store with a fully responsive UI and RESTful API integration. ΓÜ¢∩╕Å"

  if (m.match(/node|express|mern/))
    return "Full MERN stack (MongoDB, Express, React, Node.js) is one of Moiz's core stacks. His Jewellery Store project is a complete MERN application. ≡ƒƒó"

  if (m.match(/sql|database|mongo/))
    return "Moiz works with both SQL (Dermatology App, Arts & Crafts) and MongoDB (MERN Jewellery Store). Database design is a consistent part of every project he's built. ≡ƒùä∩╕Å"

  if (m.match(/java|c\+\+|oop/))
    return "Java and C++ are part of Moiz's foundational skills ΓÇö used in his Car Parking System with OOP principles and a Java GUI desktop app. Γÿò"

  if (m.match(/wordpress|ajax/))
    return "WordPress and AJAX are in Moiz's skills ΓÇö useful for CMS-based projects and dynamic frontend interactions. ≡ƒîÉ"

  if (m.match(/github|git|version control/))
    return "GitHub is Moiz's version control tool of choice ΓÇö listed in his tools section and used across all projects. ≡ƒÉÖ"

  // General programming / tech questions
  if (m.match(/what is react|what is django|what is mern|what is node|what is python/))
    return "Great tech question! While I'm focused on Moiz's profile, I can say he works hands-on with these technologies daily. Want to know specifically how he uses them in his projects? ≡ƒÿè"

  if (m.match(/best language|best framework|which is better/))
    return "That's a great debate! From Moiz's experience: Python/Django shines for backend & AI, React for frontend, and Node.js for real-time apps. He picks the right tool for the job rather than one-size-fits-all. ≡ƒ¢á∩╕Å"

  if (m.match(/salary|pay|compensat|expect|rate/))
    return "For salary or rate details, that's best discussed directly with Moiz ≡ƒÿè Reach him at moizkh369@gmail.com ΓÇö he's open to negotiation based on the role and scope."

  if (m.match(/cv|resume|download/))
    return "You can download Moiz's full resume using the 'Download Resume' button at the top of this page! It has all his project details, skills, and education. ≡ƒôä"

  // Fallback ΓÇö always mention email
  return "That's a great question! For more personalised queries like this, reach out to Moiz directly at ≡ƒôº moizkh369@gmail.com ΓÇö he'll be happy to answer in detail. Or try asking me about his skills, projects, education, or availability! ≡ƒÜÇ"
}
...
const SERVICES = [
  {
    ...
    desc: 'End-to-end web applications using React on the frontend and Django or Node.js on the backend ΓÇö from database design to deployment.',
  ...
  },
  {
    ...
    desc: 'Embedding machine learning models into real-world applications ΓÇö skin condition detection, image classification, and intelligent systems.',
...
const PROJECTS = [
  ...
  },
  {
    ...
    desc: 'Centralized admin desktop software tracking 5000+ vehicles with automated billing and real-time slot management. Migrated C++ console to Java GUI ΓÇö improving workflow efficiency by 100%.',
    tags: ['Java', 'C++', 'GUI', 'OOP'],
    accent: '#10b981',
...
const CURRENTLY = [
  { icon: '≡ƒÅù∩╕Å', label: 'Building',   value: 'AI Dermatology Assistant ΓÇö Final Year Project (due May 2026)' },
  { icon: 'ΓÜí', label: 'Sharpening', value: 'Advanced React patterns & Django REST architecture' },
  { icon: '≡ƒÆ╝', label: 'Seeking',    value: 'First full-time developer role ΓÇö open to remote & on-site' },
  { icon: '≡ƒÄ»', label: 'Target',     value: 'Push FYP AI accuracy beyond 90% before graduation' },
]

const TIMELINE = [
  { year: '2022', title: 'Started BSc Software Engineering', sub: 'NUML Islamabad ΓÇö GPA: 3.9/4.0', icon: <GraduationCap size={12} />, color: '#06b6d4' },
  { year: '2022', title: 'Built First Project', sub: 'Car Parking System ΓÇö Java/C++, 5000+ vehicles', icon: <Code2 size={12} />, color: '#818cf8' },
  { year: '2024', title: 'Full Stack eCommerce', sub: 'Arts & Crafts Platform ΓÇö PHP/SQL, 1000+ users', icon: <Globe size={12} />, color: '#a855f7' },
  { year: '2025', title: 'Mastered MERN Stack', sub: 'Jewellery Store ΓÇö 500+ products, RESTful API', icon: <Layers size={12} />, color: '#f59e0b' },
...
// ΓöÇΓöÇΓöÇ ANIMATION VARIANTS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ REUSABLE: motion div that re-animates on every scroll ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ HEADING ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ ANIMATED COUNTER ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ SKILL BAR ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
export default function App() {
  ...
  const [chatMsgs, setChatMsgs] = useState([
    { from: 'bot', text: "Hi! I'm Moiz-Bot ≡ƒñû Trained on Moiz's full resume. Ask me anything about his skills, projects, GPA, or how to hire him!" }
  ])
  ...
  return (
    <div className={`min-h-screen font-[Outfit] ${bg} ${dark ? 'text-slate-100' : 'text-slate-900'} transition-colors duration-300`}>
      ...
      {/* ΓöÇΓöÇ Scroll progress ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ Gradient orbs ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      {/* ΓöÇΓöÇ NAV ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
      ...
      <div className="relative z-10">
        ...
        {/* ΓöÇΓöÇ HERO ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ STATS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ ABOUT ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            <Reveal className="md:col-span-3" variants={slideLeft}>
              <motion.div
                ...
                <p className={`text-sm leading-relaxed mb-6 ${muted}`}>
                  I don't just write code ΓÇö I architect solutions. From a{' '}
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-6">
            <Reveal variants={fadeUp} custom={0}>
              <motion.div
                ...
                <div className="text-2xl mb-3">≡ƒîÉ</div>
            ...
            <Reveal variants={fadeUp} custom={1}>
              <motion.div
                whileHover={{ y: -3 }}
                className={`glass ${card} border ${border} rounded-2xl p-6`}>
                <div className="text-2xl mb-3">≡ƒÆ╝</div>
            ...
            <Reveal variants={fadeUp} custom={2}>
              <motion.div
                whileHover={{ y: -3 }}
                className={`glass ${card} border ${border} rounded-2xl p-6`}>
                <div className="text-2xl mb-3">≡ƒÄ»</div>
                <h3 className="font-black text-base mb-4">Beyond the Code</h3>
                <div className="space-y-2">
                  {[
                    { emoji: 'ΓÜí', text: 'Vibe Coding sessions' },
                    { emoji: '≡ƒÆ¬', text: 'Gym ΓÇö discipline that carries into code' },
                    { emoji: '≡ƒÄ╡', text: 'Music fuels the focus' },
                    { emoji: '≡ƒôê', text: 'Self Improvement daily' },
                    { emoji: '≡ƒîì', text: 'Exploring new tech & things' },
                  ].map((h, i) => (
        ...
        {/* ΓöÇΓöÇ WHAT I DO ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ SKILLS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ PROJECTS ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ JOURNEY ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        ...
        {/* ΓöÇΓöÇ CONTACT ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
                ...
                {formSent ? (
                  <div className="text-center py-12">
                    <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }} transition={{ type: 'spring', bounce: 0.5 }}
                      className="text-6xl mb-5">Γ£à</motion.div>
        ...
        {/* ΓöÇΓöÇ FOOTER ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
        <footer className={`border-t ${border} py-8 px-6 text-center`}>
          ...
          <p className={`text-xs ${muted}`}>┬⌐ 2026 Moiz Khan ΓÇö Crafted with <span className="grad-text font-bold">passion & precision.</span></p>
        </footer>

      </div>

      {/* ΓöÇΓöÇ CHATBOT ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ */}
            ...
            <motion.div key="chat"
              ...
              <div className="flex items-center justify-between px-4 py-3.5"
                ...
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-white/20 flex items-center justify-center text-lg">≡ƒñû</div>
                  <div>
                  ...
                  <div key={i} className={`flex ${msg.from === 'user' ? 'justify-end' : 'justify-start'}`}>
                    {msg.from === 'bot' && (
                      <div className="w-6 h-6 rounded-full flex items-center justify-center text-xs mr-2 flex-shrink-0 mt-0.5"
                        style={{ background: 'linear-gradient(135deg,#06b6d4,#7c3aed)' }}>≡ƒñû</div>
                    )}
        ...
        <motion.button
          ...
          <AnimatePresence mode="wait">
            {chatOpen
              ...
              : <motion.span key="bot" initial={{ rotate: 90, opacity: 0 }} animate={{ rotate: 0, opacity: 1 }} exit={{ rotate: -90, opacity: 0 }} transition={{ duration: 0.15 }}>≡ƒñû</motion.span>
            }
          </AnimatePresence>
        </motion.button>
      </div>
